...
function isAnnotation(value: unknown): value is Annotation {
  ...
  if (annotation.type === 'callout') {
    ...
    const boxValid = a.box !== null && typeof a.box === 'object'
    ...
    if (!boxValid || !isPoint(a.leaderTarget) || typeof a.text !== 'string' || typeof a.fontSize !== 'number') return false;
    // knee is optional for backward compat — auto-generated by ensureKnee at runtime
    if (a.knee !== undefined && !isPoint(a.knee)) return false;
    return true;
  }
